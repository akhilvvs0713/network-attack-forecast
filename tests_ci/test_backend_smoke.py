...
def test_model_loading():
    ...
    assert isinstance(main._model, LSTMWorldModel), "Loaded model is not an instance of LSTMWorldModel"
    ...
    assert pred_state.shape == (1, state_dim), f"Unexpected pred_state shape: {pred_state.shape}"
