...
def test_add_and_retrieve_one_flow(redis_buffer):
    ...
    flow = {"src_ip": "192.168.1.1", "dst_ip": "10.0.0.1", "timestamp": "15/02/2018 08:35:18"}
...
def test_redis_failure_handled_cleanly(mock_zadd, test_key):
    ...
    with patch("redis.Redis.zrangebyscore", side_effect=redis.RedisError("Connection lost")):
